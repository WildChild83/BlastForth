...
emit  execute  false  find-name  free  hex  hold  i  immediate  include  invert
    j  k  lshift  max  min  move  negate  nip  2nip  off  on  or  over  2over
        page  parse  parse-name  r/o  r/w  refill  rot  2rot  rshift
        s>d  space  spaces  swap  2swap  throw  true  tuck  2tuck  type
                variable  2variable  w/o  within  write-file  xor
